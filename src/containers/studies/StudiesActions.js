...
const GET_STUDY_READ_PERMISSION :'GET_STUDY_READ_PERMISSION' = 'GET_STUDY_READ_PERMISSION';
const getStudyReadPermission :RequestSequence = newRequestSequence(GET_STUDY_READ_PERMISSION);
